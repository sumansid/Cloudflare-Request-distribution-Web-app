...
[Link to the web app](https://internship-application.suman-cloudflare.workers.dev/)
...
### 1. Request the URLs from the API - [x]
...
### 1. Register a workers.dev subdomain - [x]
...
### 2. A user should be able to visit the deployed version of the site - [x]
